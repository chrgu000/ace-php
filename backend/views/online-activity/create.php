                ...
                <div class="col-xs-12">
                    <form id="create-model-form" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="clearfix">
                                    <input  name="location"  class="col-xs-12 col-sm-6">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="clearfix">
                                    <input  name="en_location"  class="col-xs-12 col-sm-6">
                                </div>
                            </div>
                        </div>
                        <div class="space-8"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="clearfix">
                                    <input  name="end_time"  class="col-xs-12 col-sm-6 date-picker">
                                </div>
                            </div>
                        </div>
                        <div class="space-8"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="clearfix">
                                    <input type="number" name="min_walk"  class="col-xs-12 col-sm-6">
                                </div>
                            </div>
                        </div>
                        <div class="space-8"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="clearfix">
                                    <input type="number" name="max_walk"  class="col-xs-12 col-sm-6">
                                </div>
                            </div>
                        </div>
                        <div class="space-8"></div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-12 col-sm-3 no-padding-right" >益跑最小公里数:</label>

                            <div class="col-xs-12 col-sm-9">
                                <div class="clearfix">
                                    <input type="number" name="min_run"  class="col-xs-12 col-sm-6">
                                </div>
                            </div>
                        </div>
                        <div class="space-8"></div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-12 col-sm-3 no-padding-right" >益跑最大公里数:</label>

                            <div class="col-xs-12 col-sm-9">
                                <div class="clearfix">
                                    <input type="number" name="max_run"  class="col-xs-12 col-sm-6">
                                </div>
                            </div>
                        </div>
                        <div class="space-8"></div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-12 col-sm-3 no-padding-right" >益行最小公里数:</label>

                            <div class="col-xs-12 col-sm-9">
                                <div class="clearfix">
                                    <input type="number" name="min_bike"  class="col-xs-12 col-sm-6">
                                </div>
                            </div>
                        </div>
                        <div class="space-8"></div>
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-12 col-sm-3 no-padding-right" >益行最大公里数:</label>

                            <div class="col-xs-12 col-sm-9">
                                <div class="clearfix">
                                    <input type="number" name="max_bike"  class="col-xs-12 col-sm-6">
                                </div>
                            </div>
                        </div>
                        <div class="space-8"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="clearfix">
                                    <textarea id="editor2" name="en_desc" ></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="space-8"></div>
...
<?php $this->beginBlock('scripts')?>
    ...
    <script>
        ...
        $.validator.addMethod("walk_limit", function(value,element,param) {
            var returnVal = true;
            console.log(param);
            var min_name = $('input[name='+param[0]+']').val();
            var max_name = $('input[name='+param[1]+']').val();
            console.log(min_name);
            console.log(max_name);
            if(parseFloat(min_name) > parseFloat(max_name)){
                returnVal = false;
            }
            return returnVal;
        },"最大公里数必须大于最小公里数");
        $('#create-model-form').validate({
            ...
            rules: {
                ...
                max_walk :{
                    walk_limit:['min_walk','max_walk'],
                },
                max_run :{
                    walk_limit:['min_run','max_run'],
                },
                max_bike :{
                    walk_limit:['min_bike','max_bike'],
                }
            },
