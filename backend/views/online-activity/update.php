...
/** @var $model common\models\OnlineActivity */
                ...
                <div class="col-xs-12">
                    <form id="create-model-form" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="clearfix">
                                    <input type="number" name="min_run" value="<?= $model->benefit_run_min?>"  class="col-xs-12 col-sm-6">
                                </div>
                            </div>
                        </div>
                        <div class="space-8"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="clearfix">
                                    <input type="number" name="max_run"  value="<?= $model->benefit_run_max?>" class="col-xs-12 col-sm-6">
                                </div>
                            </div>
                        </div>
                        <div class="space-8"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="clearfix">
                                    <input type="number" name="min_bike" value="<?= $model->benefit_bike_min?>" class="col-xs-12 col-sm-6">
                                </div>
                            </div>
                        </div>
                        <div class="space-8"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-xs-12 col-sm-9">
                                <div class="clearfix">
                                    <input type="number" name="max_bike" value="<?= $model->benefit_bike_max?>" class="col-xs-12 col-sm-6">
                                </div>
                            </div>
                        </div>
                        <div class="space-8"></div>
...
<?php $this->beginBlock('scripts')?>
    ...
    <script>
        ...
        $.validator.addMethod("walk_limit", function(value,element,param) {
            var returnVal = false;
            var min_name = $('input[name='+param['min_walk']+']').val();
            var max_name = $('input[name='+param['max_walk']+']').val();
