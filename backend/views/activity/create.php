            ...
            <div class="row">
                <div class="col-xs-12">
                    <form id="create-model-form" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <label class="control-label col-xs-12 col-sm-3 no-padding-right" >排序(数字越小越靠前):</label>

                            <div class="col-xs-12 col-sm-9">
                                <div class="clearfix">
                                    <input type="number" name="position"  class="col-xs-12 col-sm-6">
                                </div>
                            </div>
                        </div>
                        <div class="space-8"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="clearfix col-sm-9">
                                    <input id="file-path" type="hidden" name="cover[]">
                                    <input multiple id="input-id" name="file" type="file" class="file" data-preview-file-type="text" >
                                </div>
                            </div>
                        </div>
                        <div class="space-8"></div>
...
<?php $this->beginBlock('scripts')?>
    ...
    <script>
        ...
        $("#input-id").fileinput({
            ...
            filePath[previewId] = data.response.url;
