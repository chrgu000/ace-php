...
?>
    <div class="main-content">
        ...
        <div class="row">
            <div class="col-xs-12">
                <form id="update-user-form" class="form-horizontal" role="form">
                    <input type="hidden" value="<?= $model->id?>" id="admin_user_id">
                    <input type="hidden" name="_csrf-backend" value="<?= \Yii::$app->request->csrfToken?>">
                    <div class="form-group">
                        <label class="control-label col-xs-12 col-sm-3 no-padding-right" for="email">用户名:</label>
                        <div class="col-xs-12 col-sm-9">
                            <div class="clearfix">
                                <input type="text" readonly="readonly" name="username" class="col-xs-12 col-sm-6" value="<?= $model->username?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-12 col-sm-9">
                            <div class="clearfix">
                                <input type="text"  name="nickname" class="col-xs-12 col-sm-6" value="<?= $model->nickname?>">
                            </div>
                        </div>
                    </div>
                    <div class="space-8"></div>
